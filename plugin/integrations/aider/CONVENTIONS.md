...
## Agent: KolShek finance-assistant
...
> Design and build a personal budget dashboard powered by your KolShek transaction data.
...
## Skill: kolshek:categorize

> Analyze your transactions and set up category rules for expenses and income.
...
> Set up KolShek — connect your bank accounts, fetch transactions, and get your data ready.
...
## Skill: kolshek:translate

> Translate Hebrew transaction descriptions to English.
